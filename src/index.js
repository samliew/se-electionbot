...
current activity: ${config.activityCounter}
reached minimum:  ${config.roomReachedMinimumActivityCount}
reached maximum:  ${config.roomReachedMaximumActivityCount}
${JSON.stringify({ content, msg, user }, void 0, " ")}`);
