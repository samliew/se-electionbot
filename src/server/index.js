 ...
 * @param {Rescraper} rescraper bot rescraper
 ...
 */
export const startServer = async (client, room, config, election, scheduler, rescraper, announcement, options = {}) => {
    ...
    app.set("bot_rescraper", rescraper);
