...
describe('Message Guards', () => {
    ...
    const guardToMatchesMap = new Map([
        ...
        [isAskedWhoToVote, whoToVoteMatches],
        ...
        [isAskingToMoveChessPiece, chessPieceMoveMatches]
    ]);
    ...
    describe("Special matching rules", () => {
        ...
        it(isAskedWhoToVote.name, () => {
            allMatch(isAskedWhoToVote, [
