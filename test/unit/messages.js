...
describe("Messages module", () => {
    ...
    describe("sayElectionSchedule", () => {
        ...
        it('should correctly set arrow to the current phase', () => {
            ...
            const election = new Election({ electionURL: "stackoverflow.com" });
    ...
    describe('sayHI', () => {
        ...
        it('should not add phase info on no phase', async () => {
            const election = new Election({ electionURL: "https://ja.stackoverflow.com/election" });
        ...
        it('should correctly add phase info', async () => {
            ...
            const greeting = sayHI(election);
            expect(greeting).to.match(new RegExp(`The \\[election\\]\\(${electionURL}\\?tab=${phase}\\) has been cancelled.`));
        });
